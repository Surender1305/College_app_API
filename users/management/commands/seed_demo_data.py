...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        admin.is_staff = True
        admin.save()
        self.stdout.write(self.style.SUCCESS('Created/Reset Admin: admin / admin123'))

        # Faculty
        faculty1, created = User.objects.get_or_create(username='faculty1', defaults={
        ...
        faculty1.save()
        self.stdout.write(self.style.SUCCESS('Created/Reset Faculty: faculty1 / faculty123'))
        ...
        student1.save()
        self.stdout.write(self.style.SUCCESS('Created/Reset Student: student1 / student123'))
